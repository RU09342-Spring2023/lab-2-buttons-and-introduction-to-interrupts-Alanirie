...
1. The polling example draws more power since it does more things and takes more time comparedto an interrupt. The Interrupt example helps greatly reduce the system's power usage.
